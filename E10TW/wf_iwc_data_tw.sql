...
CREATE TABLE tbb.TO_BE_REPLACE_tenantId_iwc_dopr02 (
  `group` STRING,
  `year` INT,
  `month` INT,
  `day` INT,
...
CREATE TABLE tbb.TO_BE_REPLACE_tenantId_iwc_dopr03 (
  `group` STRING,
  `year` INT,
  `month` INT,
  `day` INT,
...
CREATE TABLE tbb.TO_BE_REPLACE_tenantId_iwc_dopr04 (
  `group` STRING,
  `year` INT,
  `month` INT,
  `day` INT,
...
CREATE TABLE tbb.TO_BE_REPLACE_tenantId_iwc_dopr05 (
  `group` STRING,
  currency STRING,
  currencyname STRING,
  customerid STRING,
...
CREATE TABLE tbb.TO_BE_REPLACE_tenantId_iwc_dopr06 (
  `group` STRING,
  `year` INT,
  `month` INT,
  period DECIMAL(38,6),
...
CREATE TABLE tbb.TO_BE_REPLACE_tenantId_iwc_dopr07 (
  `group` STRING,
...
CREATE TABLE tbb.TO_BE_REPLACE_tenantId_iwc_dopr08 (
  `group` STRING,
  expfinishday STRING,
...
CREATE TABLE tbb.TO_BE_REPLACE_tenantId_iwc_dopr09 (
  `group` STRING,
...
CREATE TABLE tbb.TO_BE_REPLACE_tenantId_iwc_dopr10 (
  `group` STRING,
  yearmonth STRING,
  itemclassificationcode STRING,
  itemclassificationname STRING,
...
CREATE TABLE tbb.TO_BE_REPLACE_tenantId_target_21b40d9d_36a5_429f_99db_2dc7159c253f (
  yearperiod STRING,
  `group` STRING,
  period STRING,
  `value` DECIMAL(38,6),
...
CREATE TABLE tbb.TO_BE_REPLACE_tenantId_target_6d109799_4d13_402b_8e5d_3b877d9dc6b1 (
  yearperiod STRING,
  `group` STRING,
  period STRING,
  `value` DECIMAL(38,6),
...
CREATE TABLE tbb.TO_BE_REPLACE_tenantId_target_8ad3f88a_a85f_4d5a_b9fc_f5c8bf905b1a (
  yearperiod STRING,
  `group` STRING,
  period STRING,
  `value` DECIMAL(38,6),
...
CREATE TABLE tbb.TO_BE_REPLACE_tenantId_tbl_447231e7_9255_48ea_8933_26be3d642fe6 (
